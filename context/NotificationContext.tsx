// //D:\mYapp1\frontend\context\NotificationContext.tsx
...
//    flags?: { type: string; description: string; severity: string }[];  // ← ADD
...
export type NotifItem = {
  ...
  moderationRead?: boolean;
  moderationId?: string;
  approvalStatus?: "approved" | "approved_with_warnings" | "rejected" | null;

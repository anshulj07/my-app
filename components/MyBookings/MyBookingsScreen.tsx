...
//       <Animated.View style={StyleSheet.flatten([styles.header, { opacity: headerFade, transform: [{ translateY: headerLift }] }])}>
...
//           {tabsW > 0 && (
//             <Animated.View style={StyleSheet.flatten([styles.tabIndicator, { width: tabsW / 3, transform: [{ translateX: indicatorX }] }])} />
//           )}

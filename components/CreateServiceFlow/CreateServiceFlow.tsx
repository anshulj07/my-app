...
function SuccessView({ onClose }: any) {
  return (
    <View style={styles.successContainer}>
      ...
      <Text style={[styles.successTitle, { fontSize: 22, marginBottom: 8 }]}>
        Submitted for review
      </Text>
      <Text style={[styles.successSub, { marginBottom: 28 }]}>
        Your profile is being reviewed. We'll notify you once it's approved and live.
      </Text>
      ...
      <View style={{
        ...
        <View style={{ flexDirection: 'row', alignItems: 'center', gap: 14, padding: 16 }}>
          ...
          <Text style={{ flex: 1, fontSize: 15, color: '#111' }}>Service submitted</Text>
          <View style={{ backgroundColor: '#DCFCE7', paddingHorizontal: 10, paddingVertical: 3, borderRadius: 20 }}>
            <Text style={{ fontSize: 11, fontWeight: '600', color: '#166534' }}>Done</Text>
          </View>
        </View>
        ...
        <View style={{ flexDirection: 'row', alignItems: 'center', gap: 14, padding: 16 }}>
          ...
          <Text style={{ flex: 1, fontSize: 15, color: '#111' }}>Under review by team</Text>
          <View style={{ backgroundColor: '#FEF3C7', paddingHorizontal: 10, paddingVertical: 3, borderRadius: 20 }}>
            <Text style={{ fontSize: 11, fontWeight: '600', color: '#92400E' }}>In progress</Text>
          </View>
        </View>
        ...
        {/* Step 3 — Pending */}
        <View style={{ flexDirection: 'row', alignItems: 'center', gap: 14, padding: 16 }}>
          <View style={{ width: 36, height: 36, borderRadius: 18, backgroundColor: '#F3F4F6', alignItems: 'center', justifyContent: 'center', borderWidth: 0.5, borderColor: '#E5E7EB' }}>
            <Ionicons name="rocket-outline" size={18} color="#9CA3AF" />
          </View>
          <Text style={{ flex: 1, fontSize: 15, color: '#9CA3AF' }}>Goes live after approval</Text>
        </View>
      </View>
      ...
      <View style={{
        ...
        <Text style={{ flex: 1, fontSize: 13, color: '#6B7280', lineHeight: 20 }}>
          You'll get a notification once approved — usually within 24 hours.
        </Text>
      </View>
      ...
      <TouchableOpacity onPress={onClose} style={{
        ...
        backgroundColor: '#7C4DFF', alignItems: 'center',
      }}>

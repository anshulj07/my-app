...
//     : rawId && typeof rawId === "object" && (rawId.$oid || rawId.oid) ? String(rawId.$oid || rawId.oid)
...
//   // ✅ NEW — hides FAB + Nearby when same-location stack popup is open
...
//   return (
//     <>
//       {/* ✅ onStackOpen / onStackClose wired here */}
//       <MapView
//         key={mapKey}
...
//       <MapSearchHeader
//         top={insets.top + 10} onPick={(lat, lng) => setMyLoc({ lat, lng })}
...
//         activeOpacity={0.88}
//       >
//         <Ionicons name="chatbubble-ellipses" size={20} color={C.tealText} />
//       </TouchableOpacity>
...
//       {/* ✅ FAB — hidden when stack popup open */}
//       {!mapStackOpen && (
//         <TouchableOpacity
...
//           activeOpacity={0.9}
//         >
//           <Text style={OL.fabText}>+</Text>
//         </TouchableOpacity>
//       )}

//       {/* ✅ Nearby pill — hidden when stack popup open */}
//       {!mapStackOpen && (
//         <TouchableOpacity style={OL.nearbyPill} activeOpacity={0.92} onPress={() => setShowList(true)}>
//           <Ionicons name="list" size={16} color={C.tealText} />
...
//             <Text style={P.heading}>What do you want to create?</Text>
//             <Text style={P.subheading}>Choose a type to get started</Text>

//             <TouchableOpacity style={P.option} activeOpacity={0.85}
//               onPress={() => { setDefaultKind("event_free"); setShowPicker(false); setTimeout(() => setOpen(true), 120); }}>
//               <View style={[P.iconBubble, { backgroundColor: C.tealBg, borderColor: C.teal + "44" }]}>
//                 <Text style={P.iconEmoji}>🎉</Text>
//               </View>
//               <View style={P.optionBody}>
//                 <Text style={P.optionTitle}>Event</Text>
//                 <Text style={P.optionSub}>Free or paid · people join</Text>
//               </View>
//               <View style={[P.kindBadge, { backgroundColor: C.tealBg, borderColor: C.teal + "55" }]}>
//                 <Text style={[P.kindBadgeText, { color: C.tealText }]}>Free / Paid</Text>
//               </View>
...
//               <View style={[P.iconBubble, { backgroundColor: C.purpleBg, borderColor: C.purple + "44" }]}>
//                 <Text style={P.iconEmoji}>🛠️</Text>
//               </View>
//               <View style={P.optionBody}>
//                 <Text style={P.optionTitle}>Service</Text>
//                 <Text style={P.optionSub}>Bookable slots · clients book you</Text>
//               </View>
//               <View style={[P.kindBadge, { backgroundColor: C.purpleBg, borderColor: C.purple + "55" }]}>
//                 <Text style={[P.kindBadgeText, { color: C.purpleText }]}>Bookable</Text>
//               </View>
//               <Text style={P.arrow}>›</Text>
//             </TouchableOpacity>

//             <TouchableOpacity style={P.cancelBtn} activeOpacity={0.85} onPress={() => setShowPicker(false)}>
...
//     shadowColor: C.teal, shadowOpacity: 0.15, shadowRadius: 8, shadowOffset: { width: 0, height: 4 },
//     elevation: 4, zIndex: 10,
//   },
//   fab: {
//     position: "absolute", bottom: 40, right: 24,
//     backgroundColor: C.teal, alignItems: "center", justifyContent: "center",
//     shadowColor: C.teal, shadowOpacity: 0.4, shadowRadius: 14, shadowOffset: { width: 0, height: 8 }, elevation: 8,
//   },
//   fabText: { color: "#FFFFFF", fontSize: 32, fontWeight: "800", marginTop: -2 },
//   nearbyPill: {
...
//     borderRadius: 999,
//     backgroundColor: C.card, borderWidth: 1.5, borderColor: C.teal + "55",
//     shadowColor: C.teal, shadowOpacity: 0.18, shadowRadius: 12, shadowOffset: { width: 0, height: 6 }, elevation: 6,
//   },
//   nearbyText: { color: C.tealText, fontWeight: "900", fontSize: 13, letterSpacing: 0.2 },
// });
...
//     borderTopWidth: 1.5, borderLeftWidth: 1.5, borderRightWidth: 1.5, borderColor: C.cardBorder,
//   },
//   grabber: { width: 44, height: 4, borderRadius: 999, backgroundColor: C.inputBorder, alignSelf: "center", marginBottom: 22 },
//   heading:    { fontSize: 20, fontWeight: "900", color: C.ink, letterSpacing: -0.4, marginBottom: 4 },
//   subheading: { fontSize: 13, fontWeight: "500", color: C.muted, marginBottom: 22 },
//   option: {
//     flexDirection: "row", alignItems: "center", gap: 14, padding: 16,
//     borderRadius: 20, backgroundColor: C.inputBg,
//     borderWidth: 1.5, borderColor: C.cardBorder, marginBottom: 12,
//   },
//   iconBubble: { width: 52, height: 52, borderRadius: 16, borderWidth: 1.5, alignItems: "center", justifyContent: "center", flexShrink: 0 },
//   iconEmoji:   { fontSize: 26 },
//   optionBody:  { flex: 1 },
//   optionTitle: { fontSize: 15, fontWeight: "900", color: C.ink, letterSpacing: -0.2 },
//   optionSub:   { fontSize: 12, fontWeight: "500", color: C.muted, marginTop: 3 },
//   kindBadge:   { paddingHorizontal: 10, paddingVertical: 5, borderRadius: 999, borderWidth: 1, flexShrink: 0 },
//   kindBadgeText: { fontSize: 11, fontWeight: "800" },
//   arrow:       { fontSize: 22, fontWeight: "700", color: C.hint, flexShrink: 0 },
//   cancelBtn:   { marginTop: 4, paddingVertical: 14, borderRadius: 999, backgroundColor: C.inputBg, borderWidth: 1.5, borderColor: C.cardBorder, alignItems: "center" },

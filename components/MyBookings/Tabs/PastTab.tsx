...
export default function PastTab({
  ...
  const sections: SectionT[] = past.length ? [{ title: "Past", hint: "Events you attended earlier", data: past }] : [];
    ...
    <SectionList
      ...
      ListEmptyComponent={
        <View style={styles.empty}>
          ...
          <Text style={styles.emptySub}>Your previous bookings will show up here.</Text>
        </View>
      }
      ...
      renderItem={({ item, index }) => <EventCard e={item} index={index} onPress={() => onPressEvent(item)} />}
